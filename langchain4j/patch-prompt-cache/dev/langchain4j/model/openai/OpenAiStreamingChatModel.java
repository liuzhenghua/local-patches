...
public class OpenAiStreamingChatModel implements StreamingChatModel {
    ...
    public OpenAiStreamingChatModel(OpenAiStreamingChatModelBuilder builder) {
        ...
        this.enablePromptCache = getOrDefault(builder.enablePromptCache, false);
    }
    ...
    public void doChat(ChatRequest chatRequest, StreamingChatResponseHandler handler) {
        ...
        ChatCompletionRequest openAiRequest =
                toOpenAiChatRequest(
                        chatRequest, parameters, sendThinking, thinkingFieldName, strictTools, strictJsonSchema, enablePromptCache)
                        .stream(true)
                        .streamOptions(
    ...
    public static class OpenAiStreamingChatModelBuilder {
        ...
        public OpenAiStreamingChatModelBuilder enablePromptCache(Boolean enablePromptCache) {
